...
DIRECTORYLIST=~/.mp/Ref_Lists/Logs-list
COUNTER=1
...
sed "${SELECTION}d" ~/.mp/Ref_Lists/Logs-list > ~/.mp/Ref_Lists/Logs-list.tmp
mv ~/.mp/Ref_Lists/Logs-list.tmp ~/.mp/Ref_Lists/Logs-list